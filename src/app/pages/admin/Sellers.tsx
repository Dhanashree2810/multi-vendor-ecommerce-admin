    ...
    const mockSellers: Seller[] = [
        {
            ...
            name: 'John Doe',
            shopInfo: { shopName: 'John&amp;s Shop', district: 'District 1' },
            payment: 'Paid',
                    ...
                    >
                        ...
                        <SelectContent>
                            <SelectGroup >
                                ...
                                <SelectItem value="5" className='text-[#D0D2D6]' >5</SelectItem>
                                <SelectItem value="10" className='text-[#D0D2D6]'>10</SelectItem>
                                <SelectItem value="20" className='text-[#D0D2D6]'>20</SelectItem>
                            </SelectGroup>
                        </SelectContent>
                    </Select>
                    <Input
                ...
                <div className='relative overflow-x-auto'>
                    <Table className='w-full text-sm text-left text-[#D0D2D6]'>
                        <TableHeader className='text-sm uppercase border-b border-slate-700'>
                            <TableRow>
                                <TableHead className='py-3 px-4 text-[#D0D2D6]'>No</TableHead>
                                <TableHead className='py-3 px-4 text-[#D0D2D6]'>Image</TableHead>
                                <TableHead className='py-3 px-4 text-[#D0D2D6]'>Name</TableHead>
                                <TableHead className='py-3 px-4 text-[#D0D2D6]'>Shop Name</TableHead>
                                <TableHead className='py-3 px-4 text-[#D0D2D6]'>Payment Status</TableHead>
                                <TableHead className='py-3 px-4 text-[#D0D2D6]'>Email</TableHead>
                                <TableHead className='py-3 px-4 text-[#D0D2D6]'>Status</TableHead>
                                <TableHead className='py-3 px-4 text-[#D0D2D6]'>District</TableHead>
                                <TableHead className='py-3 px-4 text-[#D0D2D6]'>Action</TableHead>
                            </TableRow>
                        </TableHeader>
